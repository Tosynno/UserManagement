...
Scenario: Create a new user
  Given I have a new user with Username "testuser", Email "test@example.com", Password "ComplexPassword123!", and ConfirmPassword "ComplexPassword123!"
  When I send a request to create the user
  Then the response should be 200
  And the user should be retrievable by ReferenceId "5236137a-74d1-4478-84a7-339123e2f6b4"

Scenario: Update an existing user
  Given I have an existing user with ReferenceId "5236137a-74d1-4478-84a7-339123e2f6b4", Username "testuser", Email "test@example.com", Password "ComplexPassword123!", and ConfirmPassword "ComplexPassword123!"
  When I send a request to update the user with ReferenceId "5236137a-74d1-4478-84a7-339123e2f6b4", Username "updateduser" and Email "updated@example.com", Password "ComplexPassword123!", and ConfirmPassword "ComplexPassword123!"
  Then the response should be 200

Scenario: Deactivate a user
  Given I have an existing user with ReferenceId "5236137a-74d1-4478-84a7-339123e2f6b4"
